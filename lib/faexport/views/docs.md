...
~~~json
{
  ...
  "journal_header": null,
  "journal_body": "Just a quick update (with a larger update to follow soon): the banner was done by <a href=\"/user/applepup\" class=\"iconusername\"><img src=\"//a.facdn.net/20190418/applepup.gif\" align=\"middle\" title=\"applepup\" alt=\"applepup\"> applepup</a>.<br>\r\n<br>\r\nAlso, we apologize for the disruption/site accessibility earlier. We were making some changes to the database to prepare for a small site update.<br>",
  "journal_footer": "<strong class=\"bbcode bbcode_b\"><span class=\"bbcode\" style=\"color: red;\">SITE NEWS/POSTING RULES</span></strong><br>\r\n1) Keep posts civil, constructive and polite.<br>\r\n2) Keep discussion on topic to the post at hand.<br>\r\n3) Treat your fellow posters with respect.",
  "name": "Fender",
  "profile": "http://www.furaffinity.net/user/fender/",
  "profile_name": "fender",
